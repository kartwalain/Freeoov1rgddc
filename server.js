...
server.listen(PORT, HOST, () => {
  ...
  console.log('║  v1.0+: FIRST-OPEN FIX — Market Overview/OC instant     ║');
  console.log('║    • Parallel REST + WS start (no blocking expiry probe) ║');
  console.log('║    • Busy-lock force-release after env detect (NEW)      ║');
  console.log('║    • WS1/2/4 smart-retry sub until chains ready          ║');
  console.log('║    • last_price fallback for ATM subscription on open    ║');
